/**
 * @fileoverview 这个是从yui 3.4.0pr1里拿过来的，主要解决在第一次有hash的时候，ie6 7会不停的出发change事件
 * @author yui team
 * @version 3.4.0pr1
 */
YUI.add('trip-history-base', function(Y) {
...
YUI.add('trip-history-hash', function(Y) {
...
}, '@VERSION@' ,{requires:['event-synthetic', 'trip-history-base', 'yui-later']});
YUI.add('trip-history-hash-ie', function(Y) {
...
}, '@VERSION@' ,{requires:['trip-history-hash', 'node-base']});
YUI.add('trip-history-html5', function(Y) {
...
}, '@VERSION@' ,{optional:['json'], requires:['event-base', 'trip-history-base', 'node-base']});


YUI.add('trip-history', function(Y){}, '@VERSION@' ,{use:['trip-history-base', 'trip-history-hash', 'trip-history-hash-ie', 'trip-history-html5']});
